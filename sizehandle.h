...
public:
	enum Direction
	{
		LeftTop, Top, RightTop, Right, RightBottom, Bottom, LeftBottom, Left, Rotate, None
	};
	SizeHandleRect(QGraphicsItem* parent,Direction d,QGraphicsItem* resizeable);
